...
class ViewController: UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    let characteristicUUID = CBUUID(string: "FFE1") // new declaration of characteristic (good)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let destinationVC = segue.destination as? TableViewController,
           ...
           SingletonClass.shared.srcharacteristic != nil {
            ...
            SingletonClass.shared.entryCode2 = SingletonClass.shared.entryCode2
            SingletonClass.shared.entryCode3 = SingletonClass.shared.entryCode3
        }
    }
...
//    Declares our homemade write function
    func write(data: String) {
        ...
        func peripheral(_ peripheral: CBPeripheral, didDiscoverServices error: Error?) {
            ...
            for service in services {
                ...
                if service.uuid == BLE_Service_UUID {
                    print("Service found")
                    connectedToLbl.text = "Connected to \((SingletonClass.shared.curPeripheral?.name!)!)"
        ...
        func peripheral(_ peripheral: CBPeripheral, didUpdateValueFor characteristic: CBCharacteristic,
            ...
            else if receivedString as String == "B" {
